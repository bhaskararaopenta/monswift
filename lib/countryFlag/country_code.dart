...
class CountryCode {
  ...
  String get _flagUri => 'assets/flags/${code.toLowerCase()}.svg';
//  String get _flagUri => 'assets/flags/au.svg';
 // String get _flagUri => CountryISOMapping().getCountryISOFlag(code.toLowerCase());
