...
class LoginPageAfterSignup extends StatefulWidget {
  const LoginPageAfterSignup({Key? key}) : super(key: key);
...
class _LoginPageAfterSignupState extends State<LoginPageAfterSignup> {
                      ...
                      child:
                        ...
                        return ElevatedButton(
                            ...
                            child: provider.isLoading
                                ...
                                : Text("Login",
                                    style: usernameController.text.isNotEmpty &&
                                        passwordController.text.isNotEmpty
  ...
  void showBottomSheetForgetPassword() {
    final _formKey = GlobalKey<FormState>();
  ...
  Future<void> showBottomSheetEmailSent(String email) async {
    final _formKey = GlobalKey<FormState>();
                                            ...
                                            : () async {
                                                if (!_showError &&
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(SnackBar(
                                                    content: Text(
                                                        'Password did not match conditions'),
                                                  ));
                                                }
                                              },
                                        /* onPressed: () {
