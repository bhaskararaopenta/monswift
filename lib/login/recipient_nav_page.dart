...
const List<String> list = <String>['Sort', 'All', 'Recent', 'Favourite'];
          ...
          onTap: () {
            Navigator.pushNamed(context,
                ...
                arguments: {
                  ...
                  Constants.beneMobileNumber: data.beneMobileNumber,
                  //  'bene_email': data!.emailController.text,
                ...
                Stack(children: [
                  CircleAvatar(
                    ...
                    child: SizedBox(
                        child: Text(
                          getInitials(
                              '${data.beneFirstName!.isNotEmpty ? data.beneFirstName!.toLowerCase().capitalize() : null}'
                                  ' ${data.beneLastName!.isNotEmpty ? data.beneLastName!.toLowerCase().capitalize() : null}'),                          style: AppTextStyles.letterTitle,
                        )),
                  ),
                  Positioned(
                      right: 0,
                      ...
                      child: Container(
                       // child: Image.asset(AssetsConstant.miniFlag),
                        child: SvgPicture.asset(CountryISOMapping().getCountryISOFlag(CountryISOMapping().getCountryISO2(data!.benificiaryCountry!)),width: 20,),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Image.asset(AssetsConstant.icStar)
                        ],
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Name, email, phone number',
