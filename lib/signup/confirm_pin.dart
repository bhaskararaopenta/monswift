...
class _ConfirmPinPageState extends State<ConfirmPinPage> {
              ...
              children: [
               ...
               /* Align(
                ...
                Align(
                  alignment: Alignment.topLeft,
                  child: Text(
                    isFromProfilePage ? 'Confirm your new PIN' : 'Confirm your PIN',
                    style: AppTextStyles.createPinTitle,
                    textAlign: TextAlign.start,
                  ),
                ),
                        ...
                        onPressed: provider.isLoading
                          ...
                          if(userPin!=enteredPin){
                            ...
                            ScaffoldMessenger.of(context)
                              ...
                              content: Text('Pin did not match. Please enter correct PIN'),
                            ));
                          }else{
                            try {
                              setState(() {
                              ...
                              if (mounted && res.success!) {
                                ...
                                Navigator.pushNamed(
                                    context, RouterConstants.addProfileRoute,
  ...
  Future<void> confirmPin(String userPin, String email) async {
    final provider = Provider.of<DashBoardProvider>(
      context,
      listen: false,
    );
